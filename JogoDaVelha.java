    ...
    **/
    ...
    private void jogadaEstrategica() {
        ...
        if (posicao == -1 && celulas[4] == null) {
            posicao = 4; // Tenta pegar o centro
        }
    ...
    // aqui o metodo de exibir o símbolo dele com base no seu número
    ...
    // verificamos se terminou ou nao ( vitoria ou empate )
    ...
    // formato do tabuleiro em string em estado atual
